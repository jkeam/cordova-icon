...
var getPlatforms = function (projectName) {
  ...
  platforms.push({
    ...
    icons : [
      { name : 'icon-phone-not@2x.png',   size : 40  },
      { name : 'icon-phone-not@3x.png',   size : 60  },
      { name : 'icon-ipad-not.png',       size : 20  },
      { name : 'icon-ipad-not@2x.png',    size : 40  },
      { name : 'icon-spot@2x.png',  size : 80  },
      { name : 'icon-spot@3x.png',  size : 120 },
